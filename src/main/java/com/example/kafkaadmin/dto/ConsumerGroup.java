...
public class ConsumerGroup {
    ...
    String partitionAssigner;
    ConsumerGroupState state;
    Node coordinator;
    Set<AclOperation> authorizeOperations;
    ...
    public static ConsumerGroup from(ConsumerGroupDescription consumerGroupDescription) {
        ...
        return ConsumerGroup.builder()
                ...
                .authorizeOperations(consumerGroupDescription.authorizedOperations())
                .build();
    }

    @Builder
    private record Member(String memberId, String groupInstanceId, String clientId, String host,
